...
console.log(objLivro('Tomates Verdes e Fritos', 360, 'Fannie Flagg'))
...
const tomatesverdesefritos = objLivro('Tomates Verdes e Fritos', 360, 'Fannie Flagg,')
...
console.log(infoLivro(tomatesverdesefritos))
